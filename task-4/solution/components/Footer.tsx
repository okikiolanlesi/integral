...
const Footer = () => {
  return (
    <div className=" bg-secondary p-5 flex flex-col sm:flex-row sm:justify-around ">
      <div className="sm:max-w-[50%] ">
        <div className="max-w-[5rem] md:max-w-[8rem] mb-2">
          <img
        ...
        <div className="text-[0.7rem] sm:text-xs text-secondary font-medium">
          <span className="font-bold">
            LaslesVPN
          </span>{' '}
          is a private virtual network that has
          unique features and has high security.
        </div>
        <div className="flex justify-start drop-shadow-md  max-w-[7rem]">
          <svg
            width="70"
            height="71"
            viewBox="0 0 70 71"
        ...
        <p className="font-light text-secondary text-[0.5rem] ">
          ©2020LaslesVPN
        </p>
      </div>
      <div className="flex justify-between space-x-5 mt-4">
        <div>
          ...
          <div className="text-[0.6rem] lg:text-xs text-secondary font-medium">
            Download
          </div>
          <div className="text-[0.6rem] lg:text-xs text-secondary font-medium">
            Pricing
