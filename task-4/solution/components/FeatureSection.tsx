...
const FeatureSection = () => {
  return (
    <section className="min-h-[24rem] lg:min-h-[30rem]  flex flex-col-reverse sm:flex-row sm:space-x-4 sm:justify-between  items-center space-y-12 sm:space-y-0 mb-8  lg:mb-10">
      <div className=" max-w-xs sm:max-w-[50%] ">
        <img src="images/Illustration 2.png" alt="" />
      </div>
      <div className="flex-col flex space-y-4 justify-end sm:max-w-[50%]">
        <h2 className="text-primary font-semibold text-xl sm:text-2xl lg:text-3xl sm:max-w-[50vw]">
