...
const ReviewCard = ({
  ...
  return (
    <div className="p-3 border-2 max-w-full sm:max-w-sm flex-shrink-0   snap-center rounded-lg hover:border-primary hover:shadow-lg duration-300 transition-all ease-linear">
      ...
      <div className="flex justify-between items-center mb-3">
        ...
        <div className="flex text-sm font-bold text-secondary space-x-1">
          <div>{rating}</div>
          <svg
            width="16"
            height="17"
